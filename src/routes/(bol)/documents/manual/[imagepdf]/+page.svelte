...
export let data:booking_response;
onMount(()=>{
console.log("after mount")
})
afterUpdate(()=>{
    
    let element = document.getElementById('bol');
    console.log("after updates")
    let opt = {
        margin:       0,
        filename:     `bol${data.quote_id}.pdf`,
    ...
    // @ts-ignore
    html2pdf().from(element).set(opt).outputPdf().then((pdf:any) =>{
        // This logs the right base64
        const base64 = window.btoa(pdf);
        ...
        const fileName = `bol${data.quote_id}.pdf`;
...
<div class="mainPrint  flex flex-col justify-around  bol textPrimary m-auto bg-white" id="bol"> 
   <div class="m-4 h-full bg-white">
    ...
    <div class="mb-2">
        <table class="">
            <tr>
                <th colspan="2" style="vertical-align: middle; text-align: center; width: 12%;">Handeling Unit</th>
                <th colspan="2" style="vertical-align: middle; text-align: center; width: 12%;">Package</th>
                <th rowspan="2" class="missedBorder" colspan="1" style="vertical-align: middle; text-align: center; width: 6%; height: 40px">HM</th>
                <th rowspan="2" class="missedBorder" colspan="1" style="vertical-align: middle; text-align: center; width: 30%;">Commodities Description</th>
                <th rowspan="2" class="missedBorder"  style="vertical-align: text-top; text-align: center; width: 10%; height:40px;">Freight Class</th>
                <th rowspan="2" class="missedBorder"  style="vertical-align: middle; text-align: center; width: 8%;">Weight</th>
                <th rowspan="2" class="missedBorder"  style="vertical-align: middle; text-align: center; width: 6%;">nmfc#</th>
                <th colspan="3"  style="vertical-align: middle; text-align: center; width: 12%;">Dimension</th>
                <th rowspan="2" class="missedBorder"  style="vertical-align: middle; text-align: center; width: 6%;">Stackable</th>
...
{:else}
<body>
    <div class="flex items-center justify-center min-h-screen  bg-[#f4f4f4] min-w-screen">
