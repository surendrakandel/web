...
export const zodBookDeliveryAddress = z.object({
    /** @gotags: dynamodbav:"address_line_1,omitempty" */
    address_line_1: z.string().min(5, "receiver street number is required"),
    /** @gotags: dynamodbav:"address_line_2,omitempty" */
    address_line_2: z.string().optional().nullable(),
    /** @gotags: dynamodbav:"street_name,omitempty" */
    street_name: z.string().min(1, "receiver street name is required"),
    /** @gotags: dynamodbav:"city,omitempty" */
    city: z.string().min(2, "receiver city is required"),
    /** @gotags: dynamodbav:"county,omitempty" */
    county: z.string().optional().nullable(),
    /** @gotags: dynamodbav:"zip_code,omitempty" */
    zip_code: z.string().min(5, "receiver zip code is not valid").max(5, "receiver zip code is not valid"),
    /** @gotags: dynamodbav:"state,omitempty" */
    state: z.string().min(2, "receiver state is required"),
...
export type zodBookDeliveryAddressType = z.infer<typeof zodBookDeliveryAddress>

export function newBookDeliveryAddress(): zodBookDeliveryAddressType{
    let addres:zodBookDeliveryAddressType = {
        address_line_1: "",
        address_line_2: "",
        street_name: "",
        city: "",
